    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        MemberDTO[] outputMembers = {
                ...
                new MemberDTO("user03", "pass03", "박종준", "leesoonsin@ohgiraffers.com", 22, '남', 1234.6)};
        ObjectOutputStream objOut = null;

        try {
            objOut = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("src/main/java/com/ohgiraffers/filterstream/testObjectStream.txt")));
        ...
        * (반대로 byte로 변환된 데이터를 다시 객체로 변환하는 기술을 역직렬화라고 함)*/
        ...
        try {
            objIn = new ObjectInputStream(new BufferedInputStream(new FileInputStream("src/main/java/com/ohgiraffers/filterstream/testObjectStream.txt");
            while(true) {
