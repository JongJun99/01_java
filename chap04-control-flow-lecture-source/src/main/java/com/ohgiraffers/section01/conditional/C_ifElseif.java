...
public class C_ifElseif {
        ...
        public void simpleIfElseIfStatement() {
            ...
            if(조건식1) {
                ...
                조건식1은 false이고, 조건식2는 true 일 때 실행할 명령문;
             } else {
                조건식 1, 2 모두 false인 경우 실행할 명령문*/

            System.out.println("산신령이 나타났다.");
            ...
            System.out.println("산신령은 다시 연못속으로 사라진다. . . .");
    ...
    public void nestedIfElseIfStatement() {
        ...
        }System.out.println(name + "학생의 점수는" + point + "이고, 둥급은 " + grade + "입니다.");
