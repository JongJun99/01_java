...
public class A_for {
    ...
    * }*/
    public void simpleForStatement(){
        ...
        /*1~10까지 1씩 증가시키면서 i 값을 출력하는 기본반복문*/
    for(int i =1; i<=10; i++) {
...
//        System.out.println(menu10 + "을 10순위로 먹고싶습니다.!");
       ...
       for (int i= 1; i<=10; i++) {
           ...
           System.out.println(menu + "를" + i + "순위로 먹고싶습니다.!");
        }
...
//        System.out.println("sum :" +sum);
    ...
    public void testFroExample3() {
        ...
        System.out.println("1부터" + random + "까지의 합은 :");
    }
    ...
    public void testForExample4() {
        ...
        * 입력된 두 수 중, 작은 수부터 큰 수까지의 합계를 구한다.*/
