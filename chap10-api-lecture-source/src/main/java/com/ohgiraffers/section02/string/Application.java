...
public class Application {
    public static void main(String[] args) {
        ...
        * 두 문자열이 같다면 0이 반환, 인자로 전달된 문자열보다 작으면 음수를, 크면 양수를 반환한다.
        ...
        * toUpperCase() : 모든 문자를 대문자로 변환시킨다.*/
        ...
        System.out.println("substring(3,6) :" + javamysql.substring(3,6));  //6번 인덱스까지 반환이지만 5번까지만 출력됨
        System.out.println("substring(3) : " + javamysql.substring(3));     //시작인덱스값부터 끝까지 출력

        /*replace() : 문자열에서 대체할 문자열로 기존 문자열을 변경해서 반환한다.*/
        System.out.println("relplace() :" + javamysql.replace("java", "python"));
