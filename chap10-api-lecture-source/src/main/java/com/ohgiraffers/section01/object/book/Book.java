...
public class Book {
    ...
    public boolean equals(Object obj) {
        ...
        if(this.title == null) {
            ...
            * 그렇지 않은 경우 false 반환
            * String 클래스가 equals() 매서드를 오버라이딩해 두었기 때문에
        ...
        /*모든 조건을 통과하면 두 인스턴스의 필드는 같은 값을 가지므로 true 반환 */
        return true;
    }
    ...
    public int hashCode() {
        ...
        * 31은 통상적인 관례이며 String 클래스의 hashCode에서도 사용한 값이다.*/
        final int PRIME = 31;
        /*31과 필드값을 이용하여 새로운 hashCoder를 연산한다.
        * 여기서 포인트는 필드값이 같은 경우 동일한 hashCode를 반환하면 된다.*/

        result = PRIME * result + this.number;
        /*String 클래스의 hashCode 메소드는 이미 재정의 되어있다.
        * 같은 값을 가지는 문자열은 동일한 hashCoder값을 반환한다.*/
