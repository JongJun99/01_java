...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /*논리 연산자의 종류
        * 1. 논리 연결 연산자 : 두 개의 피연산자를 가지는 이항 연산자이며, 두 개의 논리식을 판단하여  참거짓은 판단
        *  1-1. &&(논리 AND) 연산자 : 두개의 논리식중 모두 참 일 경우 참을 반환, 하나라도 거짓인 경우 거짓을 반환
        *  1-2. ||(논리 OR) 연산자 : 두개의 논리식중 하나라도 참일 경우 참을 반환, 둘 다 거짓말일 경우 거짓 반환
        ...
        *  2-2. */
        ...
        System.out.println("true && fasle :" + (true && false)); //false
        System.out.println("false && true :" + (false && true)); //false
        System.out.println("false && fasle :" + (false && false)); //fasle


        //or 연산자 하나라도 참이면 True, 둘 다 거짓이면 false
        System.out.println("true || true :" +(true || true));  //true
        ...
        System.out.println("a가 b보다 작으면서 c가 d보다 작은지? :" + (a<b || c<d));     //true
        System.out.println("a가 b보다 작으면서 c가 d보다 큰지? :" + (a<b || c>d));     //true
        System.out.println("a가 b보다 크면서 c가 d보다 큰지? :" + (a>b || c>d));     //true
        System.out.println("a가 b보다 크면서 c가 d보다 작은지? :" + (a>b || c<d));     //false
