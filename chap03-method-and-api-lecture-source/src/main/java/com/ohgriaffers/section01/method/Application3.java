...
public class Application3 {
    public static void main(String[] args) {
        ...
        * 4. 클래스(static)*/
        ...
        /*지역변수는 선언한 메소드 블럭 내부에서 사용 가능하다. 이것을 지역변수의 스코프라고 한다.
        * 다른 메소드간 서로 공유해야 하는 값이 존재하는 경우 메소드 호출 시 사용하는 괄호를 이요해서 값을 전달할 수 있다.
...
//        app3.testMethod(20, 30, 40);  매개변수는 int형 1개이지만 인자는 3개이기때문에 에러
//        app3.testMethod();    매개변수는 선언되어 있지만 인자로 값을 전달하지 않아서 에러
