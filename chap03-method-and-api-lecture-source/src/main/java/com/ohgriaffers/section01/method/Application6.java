...
public class Application6 {
    public static void main(String[] args) {
        ...
        *
        * return 값을 반환받기 위해서는 메소드 선언부에 리턴타입을 명시해 주어야한다.
        ...
        * 또한 메소드 선언부에 선언한 리턴타입 반환값의 자료형은 반드시 일치해야한다. */
        ...
        app6.testMethod();      //출력하는 명령어가 존재하지 않기 때문에 hello world가 출력되지않음.
    ...
    public String testMethod() {
        ...
        * 아무 값도 리턴하지 않는 경우 void, 값을 반환하는 경우네는 반환ㄱ밧의 자료형으로 작성해야한다.*/
        return "hello world";
    }
}
