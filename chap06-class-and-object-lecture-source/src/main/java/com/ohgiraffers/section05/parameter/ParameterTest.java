...
public class ParameterTest {
    ...
    public void primaryTypeparameter(int[] iarr) {
        /* 배열의 주소가 전달된다.
...
//            System.out.println(i + " ");
        ...
        System.out.println("변경 후의 배열의 값 :");
        for(int i = 0; i<iarr.length; i++){
            System.out.println(iarr[i] + " ");
        }
        System.out.println();
    ...
    public void classTypeparameter(RectAngle rectAngle) {
        System.out.println("매개변수를 전달받은 값 :" + rectAngle);

        System.out.println("변경 전 사각형의 넓이와 둘레 ========");
        rectAngle.calcArea();
        rectAngle.calcRound();

        rectAngle.setWith(100);
    ...
    public void variableLengthArraryparameter(String name, String ...hobby) {
