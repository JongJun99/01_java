...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 여러개의 다양한 데이터들을 쉽게 효과적으로 처리할 수 있도록
        ...
        * 하지만 Map은 구조상의 차이로 Collection 인터페이스에 정의하고 있지 않다.
        *
        * [ List 인터페이스 ]
        * - 순서있는 데이터 집합으로 데이터의 중복 저장을 허용한다.
        ...
        * 자동적으로 수행되는 것이지 속도가 빨라지는 것은 아니다.*/
        ...
        alist.set(1, Boolean.valueOf(true));    //valueOf : boolean <-> Boolean 변환  (valueOf를 안적어도 똑같은 결과값이 나옴 )
        alist.set(1,(true));    //위에 74번 코드랑 똑같음
        System.out.println("alist : " + alist);

        List<String> stringList = new ArrayList<>();
        stringList.add("apple");
        /*제네릭 타입을 지정하면 지정한 타입 외의 인스턴스는 저장하지 못한다.*/
//        stringList.add(123); Stirng이 아니라서 에러
        stringList.add("banana");
        stringList.add("mango");
        stringList.add("grape");
        System.out.println("stringList : " + stringList);

//        Collection.sort(stringList); //오름차순정렬 정렬하고 난 뒤 값 저장
